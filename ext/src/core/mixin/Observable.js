...
Ext.define('Ext.mixin.Observable', function(Observable) {
    ...
    return {
        ...
        * Ext.util.Observable#addListener addListener example for attaching 
        * multiple handlers at once.
        *
        * **DOM events from Ext JS Ext.Component Components**
        *
        * While _some_ Ext JS Component classes export selected DOM events (e.g. "click", "mouseover" etc), this is usually
        * only done when extra value can be added. For example the Ext.view.View DataView's **`
        ...
        * on the Ext.app.EventBus MVC EventBus. The values of this object are truthy
        ...
        * managed.
        *
        * @param item Ext.util.Observable/Ext.dom.Element item The item to which to add a listener/listeners.
        ...
        *
        * @param item Ext.util.Observable/Ext.dom.Element item The item from which to remove a listener/listeners.
        * @param {Object/String} ename The event name, or an object containing event name properties.
        ...
        */
         ...
         * @deprecated 5.5 Use #fireEventAction instead.
         */
        ...
        */
         ...
         *   **This option is only valid for listeners bound to Ext.Component Components.**
         *   The name of a Component property which references an Ext.dom.Element element 
         *   to add a listener to.
         *
         *   This option is useful during Component construction to add DOM event listeners to 
         *   elements of Ext.Component Components which will exist only after the 
         ...
         *   **This option is only valid for listeners bound to Ext.dom.Element Elements.**
         *   `true` to call Ext.event.Event#stopPropagation stopPropagation on the event object
         *   before firing the handler.
         *
         * @param {Boolean} [options.preventDefault]
         *   **This option is only valid for listeners bound to Ext.dom.Element Elements.**
         *   `true` to call Ext.event.Event#preventDefault preventDefault on the event object
         *   before firing the handler.
         *
         * @param {Boolean} [options.stopEvent]
         *   **This option is only valid for listeners bound to Ext.dom.Element Elements.**
         *   `true` to call Ext.event.Event#stopEvent stopEvent on the event object
         *   before firing the handler.
         *
