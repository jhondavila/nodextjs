...
Ext.define("Ext.util.Sortable", {
     ...
     *
     * @param {String/Ext.util.Sorter[]} [sorters] Either a string name of one of the fields in this Store's configured Ext.data.Model Model, or an array of sorter configurations.
     ...
     *
     * * `multi` :  This is mainly useful for implementing intuitive "Sort by this" user interfaces such as the Ext.grid.Panel GridPanel's column sorting UI.
     *
     ...
     *
     * May be overridden in subclasses. Ext.data.Store Store in particlar overrides
