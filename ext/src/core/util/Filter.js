 ...
 * context of MixedCollections, though Ext.data.Store Stores frequently create them when filtering and searching
...
Ext.define('Ext.util.Filter', {
    ...
    config: {
        ...
        /**
         * @cfg {String} [id]
         * An identifier by which this Filter is indexed in a Ext.data.Store#cfg-filters Store's filters collection
         *
         ...
         * Setting this property to `true` disables this individual Filter so that it no longer contributes to a Ext.data.Store#cfg-filters Store's filter set
         *
