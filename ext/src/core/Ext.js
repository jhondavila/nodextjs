 ...
 * within the Ext namespace. For example Ext#getCmp Ext.getCmp aliases
 * Ext.ComponentManager#get Ext.ComponentManager.get.
 *
 * Many applications are initiated with Ext#application Ext.application which is
 ...
 * Ext.app.Application Application` for more information about creating an app.
 *
 * A lower-level technique that does not use the `Ext.app.Application` architecture is
 * Ext#onReady Ext.onReady.
 *
...
(function () {
    ...
    Ext.apply(Ext, {
         ...
         * Ext.draw.Animator initiated cycles.
         */
        ...
        */
         ...
         * see Ext.data.Model#copy Model.copy.
         *
