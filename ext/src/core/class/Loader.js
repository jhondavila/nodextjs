 ...
 *
 * **Note** Using `Ext.require` at global scope will cause `Ext#onReady` and
 * `Ext.app.Application#launch` methods to be deferred until the required classes
...
// @require Ext.env.Ready
    ...
    Ext.apply(Loader, {
        ...
        /**
         * fixes up loader path configs by prepending Boot#baseUrl to the beginning
